...
vector<int> solve(int l,int r)
{
    if(l==r)
    {
        int coef=pow_mod(a,s[l]);
        vector<int> tmp; tmp.resize(2); tmp[0]=1; tmp[1]=coef;
        return tmp;
    }
    int mid=(l+r)/2;
    vector<int> lhs=solve(l,mid);
    vector<int> rhs=solve(mid+1,r);
